	...
	return (
		<footer className="">
  		<p>Réalisé par Jason en Anthestérion de l'an 515 avant JC.</p>
			...
			<a href="https://www.instagram.com/ivansaklov/" target="_blank" rel="nofollow noopener noreferrer">
				<img src={instagramIcon} alt="instagram-logo" className="__footer-link __bg-color-filter" />
			</a>
			<a href="https://github.com/iSaklov" target="_blank" rel="nofollow noopener noreferrer">
				<img src={githubIcon} alt="github-logo" className="__footer-link __bg-color-filter" />
			</a>
			</div>
